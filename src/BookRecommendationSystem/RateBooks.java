 ...
 * @author Surti
 */
public class RateBooks extends JFrame implements ActionListener{
    ...
    public RateBooks(String str1) {
        ...
        //create a mew drop down with all of the books that the user has not read
        Options = new Choice();
	...
	s5.setActionCommand("Very Happy");
        ...
        ButtonGroup btnRateChoice = new ButtonGroup();
    ...
    public void actionPerformed (ActionEvent e) {
        if(e.getActionCommand().equals("Select")) {
            //display selection and radio buttons
            strTitle = Options.getSelectedItem();
            lblChoice.setText("<html><div style='text-align: center;'>The selected book is<br/>" + strTitle + "<html>");
		...
		btnChange.setText("Rate Another Book");
